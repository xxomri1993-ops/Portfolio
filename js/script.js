document.addEventListener('DOMContentLoaded', () => {
  ...
  // Tapping a link, pressing Escape, or touching anything outside the panel closes it.
  ...
  document.querySelectorAll('.carousel').forEach((carousel) => {
    ...
    const prevBtn = section && section.querySelector('.carousel-arrow.prev');
    const nextBtn = section && section.querySelector('.carousel-arrow.next');
    if (!track) return;
    ...
    build();
    // Card widths depend on webfont-independent boxes, but images and fonts can still
    // shift layout — re-measure once everything has settled.
